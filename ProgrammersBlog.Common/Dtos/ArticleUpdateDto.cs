...
namespace ProgrammersBlog.Common.Dtos
{
    public class ArticleUpdateDto
    {
        ...
        [MinLength(5, ErrorMessage = "{0} alanı {1} karakterden kücük olmamalıdır.")]
        public string Title { get; set; }
        [DisplayName("İçerik")]
        [Required(ErrorMessage = "{0} alanı boş geçilmemelidir.")]
        [MinLength(20, ErrorMessage = "{0} alanı {1} karakterden kücük olmamalıdır.")]
        ...
        [MinLength(0, ErrorMessage = "{0} alanı {1} karakterden kücük olmamalıdır.")]
